/*
https://github.com/discordjs/js/issues/3576

TotomInc commented on Feb 21
It is actually possible to mock js data, without relying on Discord API (at least for my use-case).

I needed to mock a Message received from a TextChannel. This required me to mock the following js classes, in the following order:
...
Before instantiating a new Message and after instantiating a GuildMember, make sure to manually add the freshly created guild-member to the collection of members of the guild, like this: this.guild.members.set(this.guildMember.id, this.guildMember);.
*/
